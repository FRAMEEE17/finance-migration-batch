...
Scale: **97,144,587.1** across 20 documents. Full technical detail:
...
- debit/credit gap, whole scope: **90.00** (the more trustworthy figure;
  1 document excluded as unbalanced, this is what's left)

Accounts with a real local_amount gap (both from the excluded unbalanced document):
...
- Detected pairs: **1025**
- Crossing a period boundary (original and reversal in different periods): 326
- Economically valid (debit/credit correctly swap): 940
- Flagged as not a real reversal (see issue #7 - mostly planted fraud/anomaly cases): 85
...
- the 1 unbalanced document is correctly excluded; the remaining
  debit/credit gap for the period is 90.00
